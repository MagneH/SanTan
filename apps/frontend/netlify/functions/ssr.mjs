import * as serverMod from '../../dist/server/entry.mjs'
...
if (!fetchFn) {
  console.warn('[netlify ssr local] fetch handler not found in dist/server/entry.mjs')
}
...
export async function handler(event) {
  ...
  try {
    ...
    console.error('[netlify ssr local] runtime error', e)
