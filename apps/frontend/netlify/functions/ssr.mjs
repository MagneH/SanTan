// Import server entry from Nitro output (generated by build)
import * as serverMod from '../../.output/server/index.mjs'
...
if (!fetchFn) {
  console.warn('[netlify ssr] fetch handler not found in .output/server/index.mjs')
}
